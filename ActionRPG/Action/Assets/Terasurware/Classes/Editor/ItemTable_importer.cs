...
public class ItemTable_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/3.Arts/0.Table/ItemTable.xlsx";
	private static readonly string exportPath = "Assets/3.Arts/0.Table/ItemTable.asset";
