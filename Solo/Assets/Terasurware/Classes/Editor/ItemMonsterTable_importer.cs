...
public class ItemMonsterTable_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/4.Arts/Table/ItemMonsterTable.xlsx";
	private static readonly string exportPath = "Assets/4.Arts/Table/ItemMonsterTable.asset";
